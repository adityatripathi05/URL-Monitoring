...
*   **Lean Entry Point (`main.py`)**: The main application file (`main.py`) is kept minimal. Its primary responsibilities are instantiating the FastAPI application, including the main API router from `project_config.routes`, and setting up lifespan events.
